...
router.get( '/admin/stats', function( req, res, next ){
    logger.info( 'In adminRoutes | Handling ' + req.route.path );

    statsController.getStats( req, res, next);

    logger.info( 'In adminRoutes | Finished ' + req.route.path );
});
...
/* Request-Name : /admin/locations/:locationName, Type : Delete, Allowed : admin*/
/* This request would be used by admin to delete a Location. */
router.delete( '/admin/locations/:locationName', function( req, res, next ){
    logger.info( 'In adminRoutes | Handling ' + req.route.path );
...
/* Request-Name : /admin/locations/:locationName, Type : Put, Allowed : admin*/
/* This request would be used by admin to update a Location. */
router.put( '/admin/locations/:locationName', function( req, res, next ){
    logger.info( 'In adminRoutes | Handling ' + req.route.path );
