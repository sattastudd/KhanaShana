define(["module"], function(module) {
    ...
    text = {version: "2.0.3",strip: function(content) {
            ...
            var parsed = text.parseName(name), nonStripName = parsed.moduleName + "." + parsed.ext, url = req.toUrl(nonStripName), useXhr = (masterConfig.useXhr) || text.useXhr;
            ...
            var parsed = text.parseName(moduleName), nonStripName = parsed.moduleName + "." + parsed.ext, fileName = req.toUrl(parsed.moduleName + "." + parsed.ext) + ".js";
