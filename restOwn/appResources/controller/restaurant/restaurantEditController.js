define([], function ($scope) {
    function restaurantEditController() {
    };
    return restaurantEditController;
});

function NewRestaurantController($scope, $http, $rootScope, $timeout, UserInfoProvider, DataStore, AppConstants, RestRequests) {
    ...
    var optionsRequest = AppConstants.restOwnServicePrefix + '/' + RestRequests.options;
    ...
    $scope.init = function () {
        ...
        if( $scope.isEdit ) {
            ...
            $scope.restaurant.slug = UserInfoProvider.getAssignedRestaurantSlug();

            /* If we have a proper slug value stored in DataStore.*/
            if( angular.isDefined( $scope.restaurant.slug )) {

                var requestName = AppConstants.restOwnServicePrefix + '/' + RestRequests.restaurant + '/' + $scope.restaurant.slug;
    ...
    $scope.createRestaurant = function () {
        ...
        var requestName = AppConstants.restOwnServicePrefix + '/' + RestRequests.restaurants;
    ...
    $scope.saveAndContinue = function () {
        ...
        var requestName = AppConstants.restOwnServicePrefix + '/' + RestRequests.restaurant + '/' + $scope.restaurantOldSlug;
